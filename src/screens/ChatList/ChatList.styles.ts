...
export const getTheme = (isDark: boolean) => {
  ...
  return {
    ...
    brand: {
      normal: Colors.brand.light.normal,
      surface: Colors.brand.light.surface,
    },
  } as const;
};
export type ChatListTheme = ReturnType<typeof getTheme>;

export const createChatListStyles = (t: ChatListTheme) =>
  StyleSheet.create({
    ...
    emptyBtn: {
      backgroundColor: t.brand?.normal || Colors.brand.light.normal,
