...
import { getTheme as getBaseTheme, AllChatsTheme } from '../AllChats/AllChats.styles';
import { Spacing } from '../../theme/spacing';
import { Typography } from '../../theme/typography';
import { Radius } from '../../theme/radius';

export const getTheme = getBaseTheme;
export type ExploreTheme = AllChatsTheme;

export const createExploreStyles = (t: ExploreTheme) => StyleSheet.create({
  ...
  divider: { height: StyleSheet.hairlineWidth, backgroundColor: t.border, marginLeft: 52 + 14, marginRight: Spacing['spacing-group-s']},
