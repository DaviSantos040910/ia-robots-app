...
export const getTheme = (isDark: boolean) => {
  ...
  return {
    ...
    danger: {
      normal: Colors.semantic.error.normal,
...
export const createBotSettingsStyles = (t: SettingsTheme) =>
  StyleSheet.create({
    ...
    settingIconWrapper: {
      ...
      alignItems: "center",
      justifyContent: "center",
      marginRight: Spacing["spacing-element-l"],
    },
    valueRowLabel: {
    ...
    divider: {
      ...
      backgroundColor: t.border,
      marginLeft:
        Spacing["spacing-group-s"] + 40 + Spacing["spacing-element-l"],
    },
    spacer16: { height: 16 },
  });
